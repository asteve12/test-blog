  ...
  return <Box pb="24px" w="100%"  minH="56px" pt="24px" display="flex" justifyContent="space-between" alignItems="center" >
    ...
    <Stack spacing="24px">
          ...
          <InputLeftElement
            pointerEvents='none'
            h="100%"
            children={<CiSearch size={25}  color="#666481" ></CiSearch>}
          />
          <Input fontSize="16px" display="flex" alignItems="center" borderRadius="50px" w="490px" h="100%" type='tel' placeholder='Search Blog' />
        </InputGroup>
      </Stack>
