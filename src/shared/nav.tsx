...
export const NavHeader = () => {
      ...
      <header id="header" className="header-row flex flex-center w-100">
        <nav className="header-nav">
          ...
          <div className="nav-logo">
            ...
            <Image mt={["25px","0px"]} width="145px" height="60px" src="/img/navLogo.svg" alt="gruve logo" />
              </span>
            </Link>
            ...
            <div className="flex">
              ...
              <a
                href={"#join-the-hype"}
                className="hero-cta-btn flex align-center nav-cta-btn"
              >
                <div className="hero-btn-text">
                <p className="margin-0 hero-btn-p">
                  { t("navHeader.waitlist")}
        ...
        <div className="flex flex-center flex-between mob-header">
          ...
          <div className="switch">
            <div className="inner-nav-list">
              ...
              >
                <span
                  className={`event-attendees switch-item nav-link-item `}
                >
                  Switch to Attendees
                </span>
              </div>
  ...
  return <Flex
    ...
    <Menu
        ...
        styles={mobilestyles}
        customBurgerIcon={<HiMenuAlt2></HiMenuAlt2>} >
        ...
        <Button
         ...
         fontSize="14px"
          bg="#DF374D" w="343px" h="56px" borderRadius="1000px"  color="white">
          Join waitlist
          </Button>
    </Flex>
