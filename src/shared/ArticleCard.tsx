...
export const ArticleCard = ({
    ...
    return (
        <Box w={["100%","95%","389px"]} h={["auto","542px"]}   mb={["30px","0px"]}  >
            <Image w={"100%"} objectFit="cover" h={["30%","323px"]} borderRadius="16px" src={`${Base_Url}${image}`}/> 
            ...
            <Heading fontFamily="satoshi bold" textAlign={["center","left","left"]} mt="10px" mb="10px" 
            
                fontSize={["18px", "24px"]} fontWeight="900">
                {title}
